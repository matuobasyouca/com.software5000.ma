 ...
 */
public class PackClusterBuyRecord extends BaseEntity {
    public enum Daos {
        selectCountHavePayPackCluster("PackClusterBuyRecord.selectCountHavePayPackCluster"),
        selectPackClusterPerDto("PackClusterBuyRecord.selectPackClusterPerDto"),
        selectPagePackClusterBuyRecord("PackClusterBuyRecord.selectPagePackClusterBuyRecord"),
        selectPagePackClusterBuyRecordByPage("PackClusterBuyRecord.selectPagePackClusterBuyRecordByPage"),
        selectPackClusterBuyRecordDetail("PackClusterBuyRecord.selectPackClusterBuyRecordDetail"),
        selectLatelyPackClusterBuyRecord("PackClusterBuyRecord.selectLatelyPackClusterBuyRecord"),
        selectPackClusterBuyRecordCountForState("PackClusterBuyRecord.selectPackClusterBuyRecordCountForState"),
        ;
    ...
    public String getColonelOpenId() { return colonelOpenId; }

    public void setColonelOpenId(String colonelOpenId) { this.colonelOpenId = colonelOpenId; }
