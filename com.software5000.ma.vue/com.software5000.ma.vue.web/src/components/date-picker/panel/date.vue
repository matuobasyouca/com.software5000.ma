        ...
        <div :class="[prefixCls + '-body']">
            <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                <span
                    ...
                    @click="prevYear"><zs-icon icon="arrow-left" size="10"></zs-icon></span>
                <span
                    :class="iconBtnCls('prev')"
                    @click="prevMonth"
                    v-show="currentView === 'date'"><zs-icon icon="arrow-left" size="10"></zs-icon></span>
                <span
                ...
                <span
                    ...
                    @click="nextYear"><zs-icon icon="arrow-right" size="10"></zs-icon></span>
                <span
                    :class="iconBtnCls('next')"
                    @click="nextMonth"
                    v-show="currentView === 'date'"><zs-icon icon="arrow-right" size="10"></zs-icon></span>
            </div>
...
<script>
    ...
    export default {
        name: 'DatePicker',
        mixins: [Mixin],
        components: { ZsIcon, DateTable, YearTable, MonthTable, TimePicker, Confirm },
        props:{
