    ...
    export default {
        ...
        computed : {
            ...
            cells () {
                ...
                let day = getFirstDayOfMonth(date);    // 获取这个月第一天的星期数
                day = (day === 0 ? 7 : day);
                ...
                const disabledDate = parseFloat(this.disabledDate);
                let cells = [];
                const cell_tmpl = {
                    text : '',
                    type : '',
                ...
                if (day !== 7) {
                    for (let i = 0; i < day; i++) {
                        ...
                        cell.disabled = clearHours(new Date()) > time || (disabledDate == 0 ? false : (time - clearHours(new Date()) > disabledDate));
                        disabledDate == -1 && (cell.disabled = false);
                        cells.push(cell);
                    }
                }
