    ...
    export default {
        ...
        methods: {
            ...
            insertUpload() {
                ...
                this.$ajax(
                    this.$joggle.merchant.setting.importServiceItem,
                    formData,
                    true,
                    (data, loading) => {
                        loading.close();
            ...
            handleServiceItemTemplate() {
                turnToNextPage(this.$joggle.merchant.setting.serviceItemTemplate, {}, true);
            },
            /**
             *  上传选择文件到当前页面
            ...
            handleDownloadResult() {
                turnToNextPage(this.$joggle.merchant.setting.serviceItemResult, {}, true);
            }
            /* ------------------- handle (操) end -------------------*/
        }
    };
